 ...
 */
static void /*DWORD WINAPI*/ stdoutput(void *arg)
{
...
#if 0 /* wkliang:20081216 - disable builtin systray */
...
int _shttpd_set_systray(struct shttpd_ctx *ctx, const char *opt)
{
	HWND		hWnd;
	char		title[512];
...
int _shttpd_set_nt_service(struct shttpd_ctx *ctx, const char *action)
{
