...
typedef HANDLE  (WINAPI *procIcmpCreateFile)( VOID );
typedef BOOL    (WINAPI *procIcmpCloseHandle)( HANDLE IcmpHandle );
typedef DWORD   (WINAPI *procIcmpSendEcho)(
...
procIcmpCreateFile  pIcmpCreateFile;
procIcmpCloseHandle pIcmpCloseHandle;
procIcmpSendEcho    pIcmpSendEcho;
